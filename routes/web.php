...
{
    Route::get('/list', 'App\Http\Controllers\CartController@list')->name('cart.list');
    Route::post('/add', 'App\Http\Controllers\CartController@addToCart')->name('cart.add-to-cart');
